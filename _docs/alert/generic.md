...
Якщо річ має додаткову відмітку, зазвичай близько до відмітки **UA9.US**, такий як [код джерела](/mark/sources/) (наприклад _SOT_) або [повний серійний номер](/mark/serials) (наприклад SOT-A123), Ви можете перевірити джерело походження you can verify origin та/або віслікувати річ.
